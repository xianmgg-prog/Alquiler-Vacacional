...
/**
 * Bloque A: KPIs Principales
 * Muestra las métricas globales calculadas desde mockData
 */
export default function KPICards() {
  const kpis = [
    {
      title: 'Ingresos MTD',
      value: `€${globalKPIs.totalRevenueMTD.toLocaleString('es-ES', { minimumFractionDigits: 2 })}`,
      icon: DollarSign,
      trend: '+12.5%',
      trendUp: true,
      color: 'text-blue-600',
    ...
    },
    {
      ...
      value: `€${globalKPIs.totalNetProfit.toLocaleString('es-ES', { minimumFractionDigits: 2 })}`,
      icon: PiggyBank,
      trend: '+8.4%',
      trendUp: true,
